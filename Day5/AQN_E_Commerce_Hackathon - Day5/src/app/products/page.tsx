                ...
                product.map((product) => (
                  ...
                  >
                    <Link href={`/product/${product.slug.current}`}>
                      ...
                      <p className="mt-1 font-semibold">Stock: {product.inventory} pcs</p>
                    </Link>
                    <button
                      className="mt-2 w-full bg-red-600 text-white font-semibold py-2 rounded-lg shadow-md hover:shadow-lg hover:scale-105 transition-transform duration-300 ease-in-out"
                      onClick={(e) => handleAddToCart(e, product)}
                    >
                      Add To Cart
                    </button>
